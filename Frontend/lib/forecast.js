/**
 * Forecast utilities for BEOPS Grid Substation Forecasting System
 */
...
export function validateDateRange(startDate, endDate, forecastType) {
  ...
  switch (forecastType) {
    ...
    case "monthly":
      ...
      if (diffDays > 62) {
        return "Monthly forecast: maximum range is 62 days.";
      }
      break;
    case "quarterly":
      if (diffDays > 108) {
...
export function getValueUnit(forecastType) {
  if (forecastType === "hourly") return "MW";
  if (forecastType === "quarterly") return "MWh";
  return "MWh";
}
