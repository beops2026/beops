    ...
    <div className="min-h-screen bg-[#040408] text-white">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            BEOPS provides accurate electricity load forecasting for grid substation operators —
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              From short-term hourly predictions to quarterly outlooks, BEOPS gives substation
      ...
      <footer className="border-t border-white/5 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-semibold text-white">BEOPS</p>
